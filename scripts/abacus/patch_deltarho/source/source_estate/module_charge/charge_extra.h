...
class Charge_Extra
{
    ...
    /**
     * @brief write the difference of charge density
     *
     * @param ucell the cell information
     * @param chr the charge density
     * @param para_grid the grid
     * @param inp input parameters
    */
    void write_delta_rho(const UnitCell& ucell, const Charge* chr, const Parallel_Grid &para_grid);
