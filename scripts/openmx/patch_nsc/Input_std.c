...
void Input_std(char *file)
{
  ...
  *****************************************************/
  ...
  s_vec[4]="mlcd";      i_vec[4] = 3;   /* restart for non-magnetic calc. with a machine learning charge density */ 
  ...
  ****************************************************/
  ...
  /****************************************************
         non-self-consistent one-shot calculation 
         with machine learning charge density
         added by Xiwen Li
  ****************************************************/  
  Use_ML_charge_density = 0;

  if (Scf_RestartFromFile==3){
    Scf_RestartFromFile = 1;
    Use_ML_charge_density = 1;
  }  
